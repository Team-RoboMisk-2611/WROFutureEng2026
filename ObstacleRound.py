...
RED_LOWER = np.array([70, 150, 145]) #[70, 150, 145]
RED_UPPER = np.array([170, 185, 175]) #[170, 185, 175]
    ...
    if green_target:
        ...
        if CLOCKWISE:
            ...
            if green_y > 500:
                ...
                angle = CENTER + ((green_x - (WIDTH - 560)) * KP)
